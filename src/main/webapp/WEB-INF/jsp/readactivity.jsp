    ...
    <div class="main">
        <div class="sidebar">
            <ul>
                ...
                <li><a class="active" href="/read-activity"><i class="lni lni-bar-chart"></i><span>Activity's</span></a></li>
                        ...
                        <table border="1" cellpadding="10">
                            ...
                            <c:forEach var="activity" items="${activitys}">
                                <tr>
                                    ...
                                    <td><a class="booking_action"  href="/update-activity/${activity.id}">Update</a> <a class="booking_action delete" href="/delete-activity/${activity.id}">Delete</a></td>
                                </tr>
                            </c:forEach>
                        </table>
                        <br/>
                        <a class="btn_new" href="/create-activity">Create Activity</a>
        </div>
    </div>
</div>
        </body>
