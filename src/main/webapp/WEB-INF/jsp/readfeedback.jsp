    ...
    <div class="main">
        <div class="sidebar">
            <ul>
                ...
                <li><a class="active" href="/read-feedback"><i class="lni lni-support"></i><span>Feedbacks</span></a></li>
            </ul>
        </div>
                        ...
                        <table border="1" cellpadding="10">
                            ...
                            <c:forEach var="feedback" items="${feedbacks}">
                                <tr>
                                    ...
                                    <td><a class="booking_action"  href="/update-feedback/${feedback.id}">Update</a> <a class="booking_action delete" href="/delete-feedback/${feedback.id}">Delete</a></td>
                                </tr>
                            </c:forEach>
                        </table>
                        <br/>
                        <a class="btn_new" href="/create-feedback">Create Feedback</a>
        </div>
    </div>
</div>
        </body>
