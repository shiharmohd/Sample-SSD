            ...
            <h1>Package Information</h1>
                        ...
                        <table border="1" cellpadding="10">
                            ...
                            <tr>
                                ...
                                <td>${package.notes}</td>
                                <td><a class="booking_action"  href="/update-package/${package.id}">Update</a> <a class="booking_action delete" href="/delete-package/${package.id}">Delete</a></td>
                            </tr>
                            </c:forEach>
                        </table>
                        <br/>
                        <a class="btn_new" href="/create-package">Create Package</a>
        </div>
    </div>
</div>
        </body>
